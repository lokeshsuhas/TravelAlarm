...
import headout.travelalarm.Route.GoogleAbstractRouting;
...
public class AddAlarmActivity extends AppCompatActivity implements RoutingListener, GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    private int[] colors = new int[]{R.color.primarybg, R.color.cpb_blue, R.color.cpb_red, R.color.accent, R.color.primary_dark_material_light};
    ...
    public void route() {
        if (start == null || end == null) {
            ...
            GoogleRouting routing = new GoogleRouting.Builder()
                    .travelMode(GoogleAbstractRouting.TravelMode.DRIVING)
                    .withListener(this)

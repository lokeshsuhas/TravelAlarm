package headout.travelalarm.Route;
 ...
 */
public class GoogleRouting extends GoogleAbstractRouting {
    ...
    private GoogleRouting(Builder builder) {
    ...
    protected String constructURL () {
        final StringBuilder stringBuilder = new StringBuilder(GoogleAbstractRouting.DIRECTIONS_API_URL);
